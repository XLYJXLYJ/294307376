  ...
  <div class="container66">
        <div class="sort01">
            ...
            <ul>
                ...
                <li><p>道具</p><span>(682)</span></li>
                <li><p>图标</p><span>(255)</span></li>
                <li><p>特效</p><span>(87)</span></li>
                <li><p>角色</p><span>(910)</span></li>
            </ul>
        </div>
            <div class="sort02">
            <ul>
        ...
        <div class="line"></div>
            <ul class="role">
                <li>
                    <img src="../../../assets/source/rolepic.png" alt="">
                    <div class="roleup">
...
.container66 .first .roleup .money{
    position: relative;
    left: 10px;
    top: 12px;
    width: 61px;
...
.container66 .first .roleup .money span{
    font-size: 20px;
}
...
.container66 .first .seeall:hover{
    background: #90ddff;
}
