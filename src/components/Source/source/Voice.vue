<template>
  <div class="container67">
        ...
        <div class="line"></div>
            <ul class="role">
                <li>
                    <img src="../../../assets/source/musicpic.png" alt="">
                    <div class="roleup">
...
.container67 .first .roleup .money{
    position: relative;
    left: 10px;
    top: 12px;
    width: 61px;
...
.container67 .first .roleup .money span{
    font-size: 20px;
}
...
.container67 .first .seeall:hover{
    background: #90ddff;
}
